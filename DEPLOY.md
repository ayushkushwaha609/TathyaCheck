# Tathya — Free Deployment Guide

This guide helps you deploy Tathya for **$0/month** using:
...
9. Your backend URL will be: `https://tathya-api.onrender.com`
10. Test it: visit `https://tathya-api.onrender.com/api/health`
...
5. Add **Environment Variables**:
   ```
   EXPO_PUBLIC_BACKEND_URL = https://tathya-api.onrender.com
   NODE_VERSION = 20
   ```
6. Click **Save and Deploy**
7. Your app will be live at: `https://tathya.pages.dev`
...
```
 User (Mobile/Web)
       |
       v
 Cloudflare Pages (tathya.pages.dev)
   [Expo Web App - Static Files]
       |
       v  (API calls to /api/*)
 Render (tathya-api.onrender.com)
   [FastAPI Backend]
       |
       +---> MongoDB Atlas (cache)
